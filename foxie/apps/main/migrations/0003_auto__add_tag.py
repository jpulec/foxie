...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field yip on 'Tag'
        db.create_table(u'main_tag_yip', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tag', models.ForeignKey(orm[u'main.tag'], null=False)),
            ('yip', models.ForeignKey(orm[u'main.yip'], null=False))
        ))
        db.create_unique(u'main_tag_yip', ['tag_id', 'yip_id'])

    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'main_tag')

        # Removing M2M table for field yip on 'Tag'
        db.delete_table('main_tag_yip')
    ...
    models = {
        ...
        u'main.tag': {
            ...
            'yip': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['main.Yip']", 'symmetrical': 'False'})
        },
        u'main.yip': {
